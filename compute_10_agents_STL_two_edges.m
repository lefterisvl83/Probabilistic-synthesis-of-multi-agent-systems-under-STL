function [uopt, xopt, elapsedTime] = compute_10_agents_STL_two_edges(k,x0,xk,C,c,rob,xk1,xk2,e1,e2,M,A,B,ulim,t,g,j,N,gamma,gurobi_iter,E,X,K)% E is the PRS, X is the tight workspace, K is the state-feedback gain
%
y1=[];
y2=[];
for i=1:N+1
